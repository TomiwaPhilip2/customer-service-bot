...
model = genai.GenerativeModel(model_name="tunedModels/xesorsee-tega5j23ox46",
...
if response := st.chat_input("Enter text to be summarized"):
    ...
    with st.chat_message('assistant'):
        ...
        try:
            result = model.generate_content(response)
